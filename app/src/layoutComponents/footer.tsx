...
const LayoutFooter = () => {
  return (
    // <!-- component -->
<footer className="font-sans relative pt-5 pb-3 md:pb-6 bg-neutral-900 ">
				...
				<div className="text-2xl px-4">
					...
					<div className="flex-row my-4">
						...
						<a className="h-8 w-8 rounded-full outline-none focus:outline-none" type="button"
							...
							<svg className="fill-current transition duration-700 ease-in-out text-gray-700 dark:text-gray-400 hover:text-blue-500 dark:hover:text-blue-500"
						...
						<a className="h-8 w-8 rounded-full outline-none focus:outline-none" type="button"
							...
							<svg className="h-6 transition duration-700 ease-in-out text-gray-700 dark:text-gray-400 hover:text-black dark:hover:text-black"
